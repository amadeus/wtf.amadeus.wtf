...
}var a=this.ownerDocument.newElement("div",{html:this.innerHTML}).inject(this.ownerDocument.body);var b=a.innerText;a.destroy();return b;}};}Native.implement([Document,Element],{getElements:function(h,g){h=h.split(",");
