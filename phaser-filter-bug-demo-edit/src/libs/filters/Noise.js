...
Phaser.Filter.Noise = function (game) {

    Phaser.Filter.call(this, game);

    this.uniforms.lumAmount = { type: '1f', value: 1.0 };
    this.uniforms.grainSize = { type: '1f', value: 1.0 };
    this.uniforms.grainAmount = { type: '1f', value: 0.015 };
    ...
    this.fragmentSrc = [
        ...
        "float grainsize = grainSize;", //grain particle size (1.5 - 2.5)
...
Phaser.Filter.Noise.prototype = Object.create(Phaser.Filter.prototype);
Phaser.Filter.Noise.prototype.constructor = Phaser.Filter.Noise;

Phaser.Filter.Noise.prototype.init = function (width, height) {
    this.setResolution(width || this.game.width, height || this.game.height);
};

Object.defineProperty(Phaser.Filter.Noise.prototype, 'color', {
...
Object.defineProperty(Phaser.Filter.Noise.prototype, 'luminance', {
...
Object.defineProperty(Phaser.Filter.Noise.prototype, 'size', {
...
Object.defineProperty(Phaser.Filter.Noise.prototype, 'amount', {
