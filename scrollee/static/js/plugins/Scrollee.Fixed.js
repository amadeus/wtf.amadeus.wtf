...
window.Scrollee.Fixed = new Class({
	...
	attach: function(){
		...
		Scrollee.addEvent('scroll', this.bound('_handleScroll'));
		window.addEvent('resize', this.bound('updateInfo'));
	...
	detach: function(){
		...
		Scrollee.removeEvent('scroll', this.bound('_handleScroll'));
		window.removeEvent('resize', this.bound('updateInfo'));
