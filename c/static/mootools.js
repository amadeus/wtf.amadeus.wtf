...
web build:
 - http://mootools.net/core/531dd1e7f8b29a7b34a61c27cce4165b

packager build:
 - packager build Core/Class.Extras Core/Element.Style Core/Element.Dimensions Core/JSON Core/DOMReady
...
},getLeft:function(){return this.getPosition().x;}});if(typeof JSON=="undefined"){this.JSON={};}(function(){var special={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};
